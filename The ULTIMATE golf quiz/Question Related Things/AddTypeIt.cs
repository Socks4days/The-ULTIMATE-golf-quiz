...
namespace The_ULTIMATE_golf_quiz
{
    public partial class AddTypeIt : Form
    {
        ...
        {
            BaseQuestion questionToAdd = new BaseQuestion();
            questionToAdd.Question= txtBoxQuestion.Text;
            questionToAdd.CorrectAnswer = txtBoxAnswer.Text;
            questionToAdd.Id = "TI"+ QuestionList.BaseQuestions.Count+1;
            ...
            {
                QuestionList.BaseQuestions.Add(questionToAdd);
                QuestionList.SaveAllQuestions();
            }
            else
            {
